...
window.Game.Icons = (function() {
    ...
    var EVENT_ID_TO_FILE = {
        ...
        // v2.2 新事件ID
        'field_cup_1': 'trophy.png', 'field_cup_2': 'swords.png',
        'field_cup_3': 'glowing_star.png', 'field_cup_4': 'trophy.png',
        'field_cup_win': 'trophy.png', 'field_cup_lose': 'pensive.png',
        'field_derby': 'swords.png', 'field_last_minute': 'hourglass.png',
        'field_goal_drought': 'cactus.png', 'field_training_highlight': 'soccer.png',
        'coach_new_formation': 'shuffle.png', 'coach_public_criticize': 'mic.png',
        'coach_bench': 'pensive.png',
        'locker_new_teammate': 'wave.png', 'locker_captain_vote': 'medal.png',
        'locker_veteran_retire': 'old.png', 'locker_team_dinner': 'plate.png',
        'locker_storm_1': 'speaking.png', 'locker_storm_2': 'swords.png',
        'locker_storm_3': 'shuffle.png',
        'media_trap_question': 'mic.png', 'media_transfer_rumor': 'newspaper.png',
        'media_fan_banner': 'heart.png', 'media_social_post': 'phone.png',
        'media_press_conference': 'tv.png',
        'biz_endorsement': 'diamond.png', 'biz_investment': 'chart.png',
        'biz_investment_result': 'chart.png', 'biz_charity_event': 'heart.png',
        'trans_big_offer': 'briefcase.png', 'trans_big_2a': 'swords.png',
        'trans_big_2b': 'crown.png',
        'trans_end1': 'glowing_star.png', 'trans_end2': 'money.png',
        'trans_end3': 'house.png', 'trans_end4': 'ghost.png',
        'trans_agent_call': 'phone.png', 'trans_unhappy': 'arrows.png',
        'injury_minor_scare': 'bandage.png', 'injury_play_through': 'leg.png',
        'injury_recovery': 'hospital.png', 'injury_specialist': 'telescope.png',
        // 青训期
        'tutorial_1': 'camp.png', 'tutorial_2': 'soccer.png',
        'tutorial_3': 'wave.png', 'tutorial_4': 'teacher.png',
        'tutorial_5': 'telescope.png', 'tutorial_6': 'book.png',
        'tutorial_7': 'star.png', 'tutorial_8': 'memo.png', 'tutorial_9': 'money.png'
    };
    ...
    function preloadIcons() {
        ...
        // 球星肖像文件（大文件，路径为 assets/player_icons/，需单独预加载）
        var PLAYER_PORTRAITS = [
            '内马尔.png', '小罗.png', '贝克汉姆.png', '姆巴佩.png', 'C罗.png',
            '阿里.png', '朴智星.png', '巴洛特利.png', '格策.png', '瓦尔迪.png', '梅西.png'
        ];

        var iconFiles = Object.keys(fileSet);
        var loaded = 0;
        var total = iconFiles.length + PLAYER_PORTRAITS.length;
        ...
        return new Promise(function(resolve) {
            ...
            // 球星肖像：assets/player_icons/ 路径（与 ending.js 中 _renderEndingContent 一致）
            PLAYER_PORTRAITS.forEach(function(filename) {
                var img = new Image();
                img.onload = img.onerror = function() {
                    loaded++;
                    if (loaded >= total) {
                ...
                img.src = 'assets/player_icons/' + filename;
            });
