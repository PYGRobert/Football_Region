 ...
 *
 * v2.0: 事件系统重构 — 新增 Series 模块、赛季分割线、+/- 覆盖层
 * v1.5: Bug修复版本 — 布局偏移/监听器泄漏/存档污染/效果映射/动画死区/debug面板结局
 */
(function() {
    'use strict';
    ...
    function init() {
        // 验证所有模块已加载
        var modules = ['Constants', 'State', 'Utils', 'UI', 'Series', 'Events', 'Timeline', 'Ending', 'Card'];
        ...
        function initNewGame() {
            ...
            Card.loadNewEvent();
            s._peakReputation = s.reputation;
            console.log('[Main] 游戏初始化完成 - 足球生涯：抉择与传承 v2.0');
        }
    }
})();
